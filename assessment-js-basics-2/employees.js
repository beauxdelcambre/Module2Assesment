...
class Employee {
    ...
    let isabella = new Employee("Isabella", "weekday afternoons.")

    isabella.getSchedule()
...
class Manager extends Employee {
    ...
    addEmployee(emp){
         this.employee.push(["Marco"])  
         console.log(`${this.name} manages ${this.employee}`);
    }

}
    let ethan = new Manager("Ethan", "weekday mornings", ["Jess", "Nick", "Issabella"])
